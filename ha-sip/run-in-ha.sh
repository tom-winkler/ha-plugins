...
export BIND_IP="$(bashio::config 'sip_global.bind_ip')"
export MEDIA_IP="$(bashio::config 'sip_global.media_ip')"
export RTP_PORT_MIN="$(bashio::config 'sip_global.rtp_port_min')"
export RTP_PORT_MAX="$(bashio::config 'sip_global.rtp_port_max')"
